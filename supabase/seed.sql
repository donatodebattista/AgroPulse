...
begin
    ...
    -- 2.4 Asegurar que ningún campo de token quede en NULL para evitar error 500 en GoTrue
    update auth.users
    set 
    ...
    where email in ('producer@agropulse.test', 'operator@agropulse.test', 'advisor@agropulse.test');
